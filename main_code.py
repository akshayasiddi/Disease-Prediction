...
# Heading
w2 = Label(root, justify=LEFT, text="Disease Predictor using Machine Learning", fg="purple", bg="cyan")
...
lr = Button(root, text="NaiveBayes", command=NaiveBayes,bg="maroon",fg="yellow")
